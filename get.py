...
# Last update: 11/08/2021 - version 1.0
      ...
      <KKKKKKKKkr,                       ,rSKKKKKKKK<
       -"v]qj;-                             -;jq]v"-
                 ...
                 {d}Simple Information Toolkit{w}
                  {d}Author by {w}{r}@majidtdeni666{w}"""
...
if __name__ == "__main__":
    ...
    if len(arg) == 1: menu()
        ...
        if arg[1] in ("update"):
            ...
            os.system(f"wget https://github.com/majidtdeni666/getinfo/blob/main/get.py -O {path} && chmod +x {path}")
